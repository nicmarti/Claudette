...
| line_end | int | Definition end line |
| language | string | Source language |
| parent_name | string? | Enclosing class/struct (for methods) |
...
### Type
Represents a type alias, interface, or enum definition.
...
| Property | Type | Description |
|----------|------|-------------|
| source | string | Implementing class/struct |
...
# Top-level function
internal/graph/store.go::NewGraphStore

# Method on a struct
internal/graph/store.go::GraphStore.GetStats

# Nested type method
internal/graph/store.go::OuterType.InnerType.Method
```
